...
syscall(uint32_t syscallno, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	...
	//Lab 6
	case SYS_transmit_package:
		return sys_transmit_package((struct package_desc*) a1, (ssize_t) a2);

	case SYS_receive_package:
		return sys_receive_package((struct package_desc*) a1);
